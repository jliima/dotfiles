...
exports.default = (colors, bordered) => {
    ...
    'colors': {
        ...
        'editorBracketMatch.background': (customColors && customColors.special.highlight) || colors[8].hex() + '33',
        'editorBracketMatch.border': (customColors && customColors.special.border) || colors[8].hex() + '55',
        // BRACKET MATCHES
        ...
        // DIFF EDITOR
        'diffEditor.insertedTextBackground': (customColors && customColors.special.success) || colors[10].hex() + '33',
        'diffEditor.removedTextBackground': (customColors && customColors.special.error) || colors[3].hex() + '33',
        // EDITOR WIDGET
