...
"$SCRIPT_DIR/set-wallpaper-for-activity.py" 'Default' "${WALLPAPER_DIR}/Misc/icy-mountains-and-boat.png" >/dev/null 2>&1
"$SCRIPT_DIR/set-wallpaper-for-activity.py" 'Work' "${WALLPAPER_DIR}/Misc/firm-logo-4k.png" >/dev/null 2>&1
"$SCRIPT_DIR/set-wallpaper-for-activity.py" 'School' "${WALLPAPER_DIR}/Misc/book-and-coffee.jpg" >/dev/null 2>&1